...
// fingerprint of a device certificate, 40 hex characters. Accepting
// malformed input here would forward it straight to eebus-go's SHIP trust
// registration, which fails silently downstream instead of with a clear
